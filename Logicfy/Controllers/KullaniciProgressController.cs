...
namespace Logicfy.Controllers
{
    ...
    public class KullaniciProgressController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetDersProgress(int kullaniciId, int dersId)
        {
        ...
        public async Task<IActionResult> GetKisimProgress(int kullaniciId, int kisimId)
        {
        ...
        public async Task<IActionResult> GetUniteProgress(int kullaniciId, int uniteId)
        {
